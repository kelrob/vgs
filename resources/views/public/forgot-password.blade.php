  ...
  <div class="auth-wrap">
    ...
    <div class="auth-rhs">
      <form>
        ...
        <p class="login-subtitle">Please enter your email below, a password reset link will sent sent to you.</p>
        ...
        <a href="forgot-password-set.html"><button type="button" class="btn btn-primary mb-2">Reset Password</button></a>
